...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, n_head, d_model, d_k, d_v, dropout=0.1, attn_type='full', attn_local_context=None, attn_local_pos=False):
        super().__init__()
        ...
        if attn_type == 'full':
            ...
            self.attention = local_attention.LocalAttention(
                dim=d_k if attn_local_pos else None,
                window_size=attn_local_context,
                causal=False,
                look_backward=1,
                look_forward=1,
                dropout=dropout,
    ...
    def forward(self, q, k, v, mask=None):
        ...
        output = self.attention(q, k, v, input_mask=mask)
