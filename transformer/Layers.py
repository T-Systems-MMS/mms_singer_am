...
class FFTBlock(torch.nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout=0.1,
                 attn_type='full',
                 attn_local_context=None,
                 attn_local_pos=False):
        super(FFTBlock, self).__init__()
        self.slf_attn = MultiHeadAttention(
            n_head, d_model, d_k, d_v, dropout=dropout, attn_type=attn_type, attn_local_context=attn_local_context, attn_local_pos=attn_local_pos)
