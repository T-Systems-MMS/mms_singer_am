...
class DiffNet(nn.Module):
    def __init__(self, in_dims=80):
        ...
        self.params = params = AttrDict(
            # Model params
            encoder_hidden=hp.decoder_dim,
            residual_layers=hp.wn_residual_layers,
            residual_channels=hp.wn_residual_channels,
            dilation_cycle_length=hp.wn_dilation_cycle_length,
        )
